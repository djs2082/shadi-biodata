...
2. This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://shadibiodata.com ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</br>
3. The Platform is owned by Joshi Solutions, a company incorporated under the Companies Act, 1956 with its registered office at Crystal Hills Apartments, Baner, Pune (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').
...
const Terms: React.FC = () => {
  // split on two or more newlines (paragraph breaks) and collapse single newlines inside a block
  // remove any <br> tags left in the text and normalize lines
  ...
  for (const line of lines) {
    ...
    // treat headings and numbered clauses as their own paragraphs
    if (/^Terms & Conditions/i.test(line)) {
      if (current) {
        blocks.push(current.trim());
        current = '';
      }
